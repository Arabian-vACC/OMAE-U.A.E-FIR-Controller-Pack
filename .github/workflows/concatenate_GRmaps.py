...
def main():
    ...
    targets = [
        ('Maps', 'OMAE/Plugins/Ground Radar Plugin/GRpluginMaps.txt', ['regions.txt', 'regions_1.txt', 'AoRs.txt', 'regions_2.txt', 'dynamic_stands.txt', 'geo.txt', 'freetext.txt', 'nets.txt'], add_colours_and_definitions),
